export default function FloatingWhatsApp() {
    return (
        <a 
            href="https://wa.me/6281234567890?text=Halo%20Jemari%20Spa,%20saya%20ingin%20tanya%20tentang%20layanan%20ritualnya." 
            target="_blank" 
            rel="noopener noreferrer"
            className="fixed bottom-28 md:bottom-8 right-6 md:right-8 z-50 flex items-center group"
        >
            {/* Tooltip Label */}
            ...
            <div className="relative">
                ...
                <div className="relative h-16 w-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:scale-110 transition-transform duration-500">
                    <svg 
