    ...
    return (
        <section id="pricing" className="py-section bg-zenith-surface">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center mb-20">
                <span className="text-orange-600 font-bold tracking-[0.3em] uppercase text-[10px] mb-4 block">Invitations</span>
                    ...
                    {tiers.map((tier) => (
                        <div 
                            ...
                            className={`rounded-[3rem] p-10 transition-all duration-700 ${
                                tier.featured 
                                    ? 'bg-white shadow-[0_32px_64px_-16px_rgba(152,72,0,0.1)] border border-orange-100 py-16 scale-105 z-10' 
                                    : 'bg-white/50 border border-white hover:bg-white hover:shadow-xl'
                            }`}
                        >
                            <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-orange-600 mb-8">{tier.name}</h3>
                            ...
                            <button className={`w-full py-5 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] transition-all duration-500 ${
                                tier.featured
                                    ? 'bg-[#ff7d00] text-white shadow-xl shadow-orange-600/40 hover:bg-orange-500 hover:-translate-y-1'
