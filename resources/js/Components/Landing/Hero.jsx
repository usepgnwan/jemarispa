...
const serviceContent = {
    'ID': {
        ...
        'Kerokan': {
            ...
            bg: "https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&q=80&w=2000"
        },
        'Totok Wajah': {
            ...
            bg: "https://images.unsplash.com/photo-1596178065887-1198b6148b2b?auto=format&fit=crop&q=80&w=2000"
        },
        'Pijat Refleksi': {
            ...
            bg: "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&q=80&w=2000"
        },
        'Pijat Ibu Hamil': {
    ...
    return (
        <section className="relative min-h-[110vh] lg:min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 transition-opacity duration-700">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/40 to-zenith-surface/20"></div>
            </div>
            ...
            {/* Bottom Stats Grid (Repositioned to avoid overlap) */}
            <div className="absolute bottom-8 lg:bottom-12 left-0 right-0 hidden lg:block">
                <div className="mx-auto max-w-xl px-6">
                    <div className="grid grid-cols-3 gap-x-4 items-center justify-center bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl scale-90">
                        <div className="text-center">
                            <p className="text-white text-xl font-serif italic">12+</p>
                            <p className="text-white/40 text-[8px] font-bold uppercase tracking-[0.1em] mt-1">{lang === 'ID' ? 'Layanan' : 'Practices'}</p>
                        </div>
                        <div className="h-8 w-px bg-white/10 mx-auto"></div>
                        <div className="text-center">
                            <p className="text-white text-xl font-serif italic">4.9</p>
                            <p className="text-white/40 text-[8px] font-bold uppercase tracking-[0.1em] mt-1">{lang === 'ID' ? 'Rating Member' : 'Member Rating'}</p>
                        </div>
                    </div>
                </div>
            </div>
