...
export default function Edit({ blog }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        tag: blog.tag || '',
        type_package: blog.type_package || '',
        thumbnail: null,
        _method: 'PUT' // Inertia workaround for file uploads with PUT
    });
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                        ...
                                        <div className="mt-3 flex justify-center rounded-xl border-2 border-dashed border-gray-300 px-6 py-10 bg-white hover:border-[#0057B8] transition-colors">
                                            <div className="text-center w-full">
                                                ...
                                                <p className="text-xs leading-5 text-gray-500 mt-2">Biarkan kosong jika tidak ingin mengubah gambar.</p>
                                            </div>
                                        </div>
