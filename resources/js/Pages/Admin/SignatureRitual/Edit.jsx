...
export default function Edit({ ritual }) {
    const { data, setData, post, processing, errors } = useForm({
        _method: 'PUT',
        title_id: ritual.title_id || '',
        title_en: ritual.title_en || '',
        category_id: ritual.category_id || '',
        category_en: ritual.category_en || '',
    ...
    const submit = (e) => {
        e.preventDefault();
        // Use post with _method PUT to handle file uploads in Laravel
        post(route('admin.signature-ritual.update', ritual.id));
    };

    return (
        <AuthenticatedLayout>
            <Head title={`Edit Main Service: ${ritual.title_id}`} />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 px-2 sm:px-0">
                        ...
                        <h2 className="font-bold text-2xl text-gray-900 flex items-center gap-2">
                            ...
                            Edit Main Service: {ritual.title_id}
                        </h2>
                    </div>
