...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ $meta['title'] ?? config('app.name', 'Pijat Panggilan Bandung & Cimahi - Jemari Home Spa') }}</title>
        <meta name="description" inertia content="{{ $meta['description'] ?? 'Layanan pijat panggilan Bandung terpercaya. Jemari Home Spa melayani pijat panggilan ke rumah, hotel, dan apartemen di area Bandung & Cimahi. Terapis pria & wanita profesional.' }}">
        <meta name="keywords" inertia content="pijat panggilan bandung, pijat panggilan cimahi, spa panggilan bandung, pijat tradisional bandung, massage panggilan bandung, pijat ke rumah bandung, pijat panggilan hotel bandung, terapis pijat bandung, lulur panggilan bandung, bekam panggilan bandung, pijat refleksi bandung, pijat panggilan terdekat dari lokasi saya">
    ...
    <body class="font-sans antialiased">
        ...
        @if(isset($meta['static_content']))
            <div id="seo-content" style="display: none; visibility: hidden;">
                {!! $meta['static_content'] !!}
            </div>
        @else
            <div id="seo-content" style="display: none; visibility: hidden;">
                <h1>Pijat Panggilan Bandung &amp; Cimahi - Jemari Home Spa</h1>
                <p>Jemari Home Spa adalah layanan <strong>pijat panggilan Bandung</strong> profesional terpercaya untuk area Kota Bandung, Cimahi, Kabupaten Bandung, dan Bandung Barat. Kami melayani jasa pijat panggilan ke rumah, hotel, dan apartemen dengan terapis pria dan wanita bersertifikat dan berpengalaman.</p>
        ...
        <script type="application/ld+json">
        {
          ...
          "priceRange": "$$",
          "description": "Layanan pijat panggilan Bandung. Jemari Home Spa melayani pijat tradisional, refleksi, lulur ke rumah dan hotel di Bandung dan Cimahi.",
          "areaServed": [
            {
              "@@type": "City",
              "name": "Bandung"
