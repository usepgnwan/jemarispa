...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Setting::create([
            'phone' => '089516166090',
            'email' => 'jemari.homespa27@gmail.com',
